...
export class ParamLibsComponent extends BaseParamComponent {
  ...
  getHidden() {
    return this.form.controls['rec.EdmsParm'].value === 'DB2' ||
           this.form.controls['rec.EdmsParm'].value === 'DB' ||
           this.form.controls['rec.EdmsParm'].value === 'GRStorage14' ||
           this.form.controls['rec.EdmsParm'].value === 'GRStorage11';
  }
  cancel() {
