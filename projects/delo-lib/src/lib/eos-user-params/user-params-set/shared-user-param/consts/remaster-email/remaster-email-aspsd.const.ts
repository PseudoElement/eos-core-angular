...
export const REGISTRATION_ASPSD: IBaseUsers = {
    ...
    disabledFields: [
        'RCSEND_ASPSD_REGISTRATION_NUMBER',
        'RCSEND_ASPSD_REGISTRATION_NUMBER_SUBSET',
        'RCSEND_ASPSD_DATE_OF_REGISTRATION',
        'RCSEND_ASPSD_DOCUMENT_AUTHOR_ORGANIZATION_ABBREVIATION',
        'RCSEND_ASPSD_VISAS_ORGANIZATION_ABBREVIATION',
        'RCSEND_ASPSD_ADDRESSES_ORGANIZATION_ABBREVIATION',
        'RCSEND_ASPSD_DOCUMENT_PERFORMER_ORGANIZATION_ABBREVIATION',
        'RCSEND_ASPSD_ORDERS_RESOLUTION_AUTHOR_ORGANIZATION_ABBREVIATION',
        'RCSEND_ASPSD_EXECUTOR_ORGANIZATION_ABBREVIATION',
        'RCSEND_ASPSD_ORDERS_SYSTEM_NUMBER',
        'RCSEND_ASPSD_ORDERS_POINT_RESOLUTION',
        'RCSEND_ASPSD_ADDRESSEES',
        'RCSEND_ASPSD_ADDRESSEES_RADIO_SPEC_CHANNEL'
    ],
    fields: [
