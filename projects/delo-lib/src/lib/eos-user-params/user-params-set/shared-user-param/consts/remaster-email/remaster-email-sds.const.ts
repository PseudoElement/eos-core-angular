...
export const REGISTRATION_SDS: IBaseUsers = {
    ...
    disabledFields: [
        'RCSEND_SDS_REGISTRATION_NUMBER',
        'RCSEND_SDS_REGISTRATION_NUMBER_SUBSET',
        'RCSEND_SDS_DATE_OF_REGISTRATION',
        'RCSEND_SDS_DOCUMENT_AUTHOR_ORGANIZATION_ABBREVIATION',
        'RCSEND_SDS_VISAS_ORGANIZATION_ABBREVIATION',
        'RCSEND_SDS_ADDRESSES_ORGANIZATION_ABBREVIATION',
        'RCSEND_SDS_DOCUMENT_PERFORMER_ORGANIZATION_ABBREVIATION',
        'RCSEND_SDS_ORDERS_RESOLUTION_AUTHOR_ORGANIZATION_ABBREVIATION',
        'RCSEND_SDS_EXECUTOR_ORGANIZATION_ABBREVIATION',
