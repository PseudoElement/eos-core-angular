...
import { REGISTRATION_SSTU } from '../../../../eos-user-params/user-params-set/shared-user-param/consts/remaster-email/remaster-email-ssty.const';
@Component({
    selector: 'eos-remaster-sstu',
    templateUrl: 'remaster-sstu.component.html',
    providers: [FormHelperService]
})
export class RemasterSstuComponent implements OnInit, OnDestroy {
    @Input() userData;
    @Input() defaultValues;
    ...
    pretInputs() {
        this.prapareData =  this.formHelp.parse_Create(REGISTRATION_SSTU.fields, this.userData);
        this.prepareInputs = this.formHelp.getObjectInputFields(REGISTRATION_SSTU.fields);
    ...
    default() {
        this.prepareDefaultForm = this.formHelp.parse_Create(REGISTRATION_SSTU.fields, this.defaultValues);
