...
import { OTHER_USER_DISPATCH } from '../../shared-user-param/consts/other.consts';
...
@Component({
    selector: 'eos-user-param-dispatch',
    templateUrl: 'user-param-dispatch.component.html',
    providers: [FormHelperService],
})

export class UserParamDispatchComponent implements OnDestroy, OnInit {
    @Input() defaultValues;
    ...
    inint() {
        this.prepareData = this.formHelp.parse_Create(OTHER_USER_DISPATCH.fields, this.allData);
        this.prepareInputs = this.formHelp.getObjectInputFields(OTHER_USER_DISPATCH.fields);
    ...
    default(event?) {
        this.prepareData = {};
        this.prepareInputs = {};
        this.prepareData = this.formHelp.parse_Create(OTHER_USER_DISPATCH.fields, this.defaultValues);
        this.prepareInputs = this.formHelp.getObjectInputFields(OTHER_USER_DISPATCH.fields);
