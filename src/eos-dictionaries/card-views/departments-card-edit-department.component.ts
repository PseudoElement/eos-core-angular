...
export class DepartmentsCardEditDepartmentComponent extends BaseCardEditComponent implements OnChanges, OnInit {
    ...
    chooseOrganiz() {
        ...
        if (config) {
            ...
            const params = 'Classif=CONTACT&value_id=__ClassifIds&app=nadzor&skip_deleted=True&select_nodes=False&select_leaf=True&return_due=True&search-filter={"CONT.NOT_LINK_DEPARTMENT":"Null"}"';
