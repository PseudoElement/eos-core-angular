...
import {
    ...
    DG_TPL_D, DG_TPL_NUM_NP, DG_TPL_SEPARATOR, DG_TPL_SEPARATOR2, DG_TPL_COMB1,
    DG_TPL_COMB2, DG_TPL_COMB3, DG_TPL_COMB4, DG_TPL_NUM_ORG, DG_TPL_INDEX, DG_TPL_MANUAL_NUMBER_DOCCB, DG_TPL_MANUAL_NUMBER_PRJCB, DG_TPL_LINKED_DOC_REG_NUMBER_WRL, DG_TPL_LINK_IDX_WL, DG_TPL_LINKED_DOC_NUMBER_WRL, DG_TPL_RK_NUMBER_WRL
