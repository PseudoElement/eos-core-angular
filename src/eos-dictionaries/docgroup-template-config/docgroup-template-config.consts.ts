...
export const DG_TPL_SIGANTORY_IDX: DGTplElement = { key: '{4}', title: 'Индекс лица, подписавшего документ', possibleRKType: /^[3]$/, };
export const DG_TPL_DEP_IDX: DGTplElement = { key: '{5}', title: 'Индекс подразделения исполнителя', possibleRKType: /^[3]$/, };
export const DG_TPL_PREFIX: DGTplElement = { key: '{6}', title: 'Префикс обращений граждан', possibleRKType: /^[2]$/, };
...
export const DG_TPL_NUM_NP: DGTplElement = { key: '{N}', title: 'Номер НП', possibleRKType: /^[3]$/ };
