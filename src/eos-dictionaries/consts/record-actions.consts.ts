...
const RECORD_CHECK_UNIQUE_INDEX: IAction = {
    ...
    iconClass: 'eos-icon eos-icon-check-uniq-index-blue small',
    disabledIconClass: 'eos-icon eos-icon-check-uniq-index-grey small',
    activeIconClass: 'eos-icon eos-icon-check-uniq-index-white small',
    hoverIconClass: 'eos-icon eos-icon-check-uniq-index-white small',
    buttonClass: null,
    accessNeed: APS_DICT_GRANT.read,
};
...
export const RENAME_BASE_DIRECTORY: IAction = {
    ...
    iconClass: 'eos-icon eos-icon-card-index-blue small',
    disabledIconClass: 'eos-icon eos-icon-card-index-grey small',
    hoverIconClass: 'eos-icon eos-icon-card-index-grey small',
    activeIconClass: null,
    buttonClass: null,
    accessNeed: APS_DICT_GRANT.readwrite,
};
