...
export const USER_PARAM: IDepartmentDictionaryDescriptor = {
    id: 'user_param',
    ...
    actions: ['add', 'markRecords', 'quickSearch', 'fullSearch', 'order', 'userOrder', 'import', 'export', 'importPhotos',
        'tableCustomization', 'showAllSubnodes', 'edit', 'view', 'slantForForms', 'restore', 'remove', 'removeHard',
        'showDeleted', 'tuneFields'],
    keyField: 'DUE',
    parentField: 'PARENT_DUE',
    modeField: 'IS_NODE',
    searchConfig: [SEARCH_TYPES.full, SEARCH_TYPES.quick],
    modeList: [{
        key: 'department',
        title: 'Подразделение',
    }, {
