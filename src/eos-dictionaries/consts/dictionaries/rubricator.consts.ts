...
import { COMMON_FIELDS, COMMON_FIELD_CODE, COMMON_FIELD_NAME, COMMON_FIELD_FULLNAME, COMMON_FIELD_ICONS, ICONS_CONTAINER, COMMON_FIELD_ICONS_SEV, ICONS_CONTAINER_SEV, } from './_common';
