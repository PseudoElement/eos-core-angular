...
export class DepartmentRecordDescriptor extends RecordDescriptor {
    dictionary: UserParamDictionaryDescriptor;
    parentField: FieldDescriptor;
    modeField: FieldDescriptor;
    modeList: IRecordModeDescription[];
    fullSearchFields: ModeFieldSet | any;

    constructor(dictionary: UserParamDictionaryDescriptor, descriptor: IDepartmentDictionaryDescriptor) {
...
export class UserParamDictionaryDescriptor extends TreeDictionaryDescriptor {
