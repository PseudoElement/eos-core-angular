...
export class UserParamOtherSrv extends BaseUserSrv {
  ...
  /*  prepDataAttachField(data) {
    ...
    selectfromTheDirectory() {
        // http://localhost/X182/Pages/Classif/ChooseClassif.aspx?Classif=DOCGROUP_CL&value_id=ctl00_PageBody_c_RC__DUE_DOCGROUP_Ids&name_id=ctl00_PageBody_c_RC__DUE_DOCGROUP&skip_deleted=False&return_due=True
    }
}
