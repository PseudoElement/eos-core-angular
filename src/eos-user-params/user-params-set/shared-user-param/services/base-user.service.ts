...
export class BaseUserSrv implements OnDestroy, OnInit {
    ...
    init() {
        ...
        return this.getData({
            USER_PARMS: {
                criteries: {
                    PARM_NAME: 'WINPOS||SORT||SRCH_CONTACT_FIELDS||SRCH_LIMIT_RESULT||SEARCH_CONTEXT_CARD_EMPTY' +
'||SEND_DIALOG||DELFROMCAB||MARKDOC||MARKDOCKND||RS_OUTER_DEFAULT_DELIVERY||MARKDOCKND1||GPD_FLAG||VOL_FLAG||CUR_CABINET' +
