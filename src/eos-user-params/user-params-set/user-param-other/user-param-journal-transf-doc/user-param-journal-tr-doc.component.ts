...
import { JOURNAL_TR_DOC_USER } from '../../shared-user-param/consts/other.consts';
...
@Component({
    selector: 'eos-user-param-journal-tr-doc',
    templateUrl: 'user-param-journal-tr-doc.component.html',
    providers: [FormHelperService],
})

export class UserParamJournalTrDocComponent implements OnDestroy, OnInit {
    @Input() defaultValues;
    ...
    inint() {
        this.prepareData = this.formHelp.parse_Create(JOURNAL_TR_DOC_USER.fields, this.allData);
        this.prepareInputs = this.formHelp.getObjectInputFields(JOURNAL_TR_DOC_USER.fields);
    ...
    default(event?) {
        this.prepareData = {};
        this.prepareInputs = {};
        this.prepareData = this.formHelp.parse_Create(JOURNAL_TR_DOC_USER.fields, this.defaultValues);
        this.prepareInputs = this.formHelp.getObjectInputFields(JOURNAL_TR_DOC_USER.fields);
